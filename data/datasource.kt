...
class datasource {
    fun loadAttendance(): List<Record> {
        return listOf<Record>(
            ...
            Record(R.string.rollno1,R.string.student_name2,false),
            Record(R.string.rollno2,R.string.student_name3,false),
            Record(R.string.rollno3,R.string.student_name4,false),
            Record(R.string.rollno4,R.string.student_name5,false),
